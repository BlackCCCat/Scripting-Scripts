                  ...
                  >
                    ...
                    <HStack padding={{ top: 8, bottom: 8 }}>
                      ...
                      <VStack alignment="leading">
                        ...
                        <HStack spacing={4}>
                          <Text foregroundStyle="secondaryLabel">{task.calendarTitle}</Text>
                          {countdownLabel ? (
                            <Text foregroundStyle="secondaryLabel">· {countdownLabel}</Text>
                          ) : null}
                          {notifyLabel ? (
                            <HStack spacing={4}>
                              ...
                              <Image
                                ...
                                imageScale="small"
                              />
                              <Text foregroundStyle="secondaryLabel">{notifyLabel}</Text>
                            </HStack>
                          ) : null}
                        </HStack>
                      </VStack>

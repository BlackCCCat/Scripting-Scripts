...
export type ProSchemeKey = "moqi" | "flypy" | "zrm" | "tiger" | "wubi" | "hanxin" | "shouyou" | "shyplus"
export type InputMethod = "hamster" | "hamster3"
export type HomeSectionKey = "local" | "remote" | "notes" | "actions" | "status"

export const PRO_KEYS: ProSchemeKey[] = ["moqi", "flypy", "zrm", "tiger", "wubi", "hanxin", "shouyou", "shyplus"]
